...
export const metadata: Metadata = {
  ...
  description: "About Tutorly - The Academic Atelier.",
};
      ...
      <nav className="sticky top-0 z-50 bg-[#F8FAFC]">
        <div className="max-w-6xl mx-auto px-6 h-20 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <Link href="/pricing" className="text-sm font-medium text-[#43474e] hover:text-[#022448] transition-colors">Pricing</Link>
            <Link href="/about" className="text-sm font-medium text-[#022448] border-b-2 border-[#022448] pb-1">About</Link>
          </div>
